package com.lwhtarena.edu.service.user.common.core.dao;

import com.lwhtarena.edu.common.entity.BaseEntity;
import com.lwhtarena.edu.common.exceptions.BizException;
 ...
 * @描述: 数据访问层基础支撑类.
 * @author lwh
 * @folder com.lwhtarena.edu.service.user.common.core.dao
 * @date 2016/9/1.
