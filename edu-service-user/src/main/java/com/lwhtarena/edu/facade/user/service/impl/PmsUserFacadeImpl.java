package com.lwhtarena.edu.facade.user.service.impl;
...
import com.lwhtarena.edu.service.user.biz.PmsUserBiz;
 ...
 * @描述: 用户Dubbo服务接口实现 .
 * @author lwh
 * @folder com.lwhtarena.edu.facade.user.service.impl
 * @date 2016/9/1.
